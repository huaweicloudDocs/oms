# 创建任务<a name="ZH-CN_TOPIC_0126410617"></a>
...
<a name="ul14975428175715"></a><a name="ul14975428175715"></a><ul id="ul14975428175715"><li>list：对象列表迁移</li><li>object：文件/文件夹迁移</li><li>prefix：对象前缀迁移<div class="note" id="note965718556315"><a name="note965718556315"></a><a name="note965718556315"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p196583558318"><a name="p196583558318"></a><a name="p196583558318"></a>当task_type为list时，<a href="#table654613914145">表3</a>中list_file为必选参数。当task_type为object或prefix时，<a href="#table654613914145">表3</a>中object_key为必选参数。</p>
</div></div>
</li></ul>
</td>
</tr>
...
<div class="note" id="note0440827123910"><a name="note0440827123910"></a><a name="note0440827123910"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p158764024717"><a name="p158764024717"></a><a name="p158764024717"></a>当<a href="#table59133445">表2</a>中task_type为list时，list_file为必选参数。</p>
</div></div>
</td>
</tr>
...
<p id="p23417850114547"><a name="p23417850114547"></a><a name="p23417850114547"></a>可选值有AWS、 Aliyun、Tencent、HuaweiCloud、QingCloud、KingsoftCloud、Baidu或者Qiniu。默认值为Aliyun。</p>
...
<td class="cellrowborder" valign="top" width="43.75437543754375%" headers="mcps1.2.5.1.4 "><p id="p112781171078"><a name="p112781171078"></a><a name="p112781171078"></a>对象列表文件对象名。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="44.604460446044605%" headers="mcps1.2.5.1.4 "><p id="p44394316464"><a name="p44394316464"></a><a name="p44394316464"></a>流量控制开始时间（包含），格式为“hh:mm”。例如“12:03”表示12时03分。</p>
</td>
</tr>
